...
<div class="bg-dark text-white py-5" style="min-height: 100vh;">
    <div class="container">
        ...
        <!-- Services -->
        <div class="mb-5" data-aos="fade-up">
            <h4 class="fw-bold text-center mb-4" style="color: #FFD700;">Our Services</h4>
            <div class="row g-4">
                @php
                    $services = [
                        ['title' => 'Mobile App Development', 'desc' => 'Our service covers the entire development, from UI/UX design to App Store and Play Store submission.', 'icon' => 'fa-mobile-alt'],
                        ['title' => 'Web Development', 'desc' => 'We are a team that is easy to work with—from interface design to interactive websites. We got your back.', 'icon' => 'fa-globe'],
                        ['title' => 'System Development', 'desc' => 'We make life easier with well-engineered products that will cater to client needs.', 'icon' => 'fa-desktop'],
                        ['title' => 'Multimedia Production', 'desc' => 'Team up with our creative and passionate artists. We can provide production equipment and editing services.', 'icon' => 'fa-photo-film'],
                        ['title' => 'Game Development', 'desc' => 'Let’s bring your imagination to life through 2D and 3D games built in Unity.', 'icon' => 'fa-gamepad'],
                        ['title' => 'Branding and Design', 'desc' => 'We offer high-quality websites that suit your brand and style.', 'icon' => 'fa-pen-nib'],
                        ['title' => 'Digital Marketing', 'desc' => 'Keep your audience engaged! We offer stunning graphics and copywriting services.', 'icon' => 'fa-bullhorn'],
                    ];
                @endphp
                ...
                @foreach($services as $service)
                    <div class="col-md-4 col-sm-6" data-aos="zoom-in">
                        <div class="card service-card bg-dark text-white border border-secondary rounded-4 shadow-lg h-100 text-center p-4 position-relative">
                            ...
                            <h5 class="fw-bold mb-2" style="color: #FFD700;">{{ $service['title'] }}</h5>
